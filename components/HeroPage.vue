<template>
  <div class="flex lg:flex-row flex-col gap-4 bg-surface-0 h-70vh ">
    <div class="flex-1 flex items-center justify-center app-container ">
      <div class="p-6 pt-12 lg:p-12 max-w-600px mx-auto">
