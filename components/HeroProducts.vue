<template>
  <div class="bg-white app-container">
    <div class="py-16 sm:py-24 flex flex-col gap-4rem">
      <div class="flex items-center justify-between px-4 sm:px-6 lg:px-0">
        <div
          ...
          gap-1rem
        >
          <h2 class="text-base/7 font-semibold text-indigo-800">
            Vyber si tričko !
          </h2>
          <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-surface-900 sm:text-5xl">
            Doporučené produkty
          </p>
        </div>
        <a
          href="#"
          class="hidden text-sm font-semibold text-indigo-800 hover:text-indigo-900 sm:block"
        >
          Do obchodu
